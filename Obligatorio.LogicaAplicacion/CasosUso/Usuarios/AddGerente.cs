...
{
    public class AddGerente : ICUAddGerente<UsuarioDtoAlta>
    {
        private IRepositorioUsuario _repo;
        public AddGerente(IRepositorioUsuario repo)
        {
            _repo = repo;
        }
        ...
        public void Execute(UsuarioDtoAlta usuarioDto)
        {
            try
            {
                ...
                Gerente usuario = UsuarioMapper.FromDtoGerente(usuarioDtoMail);
                _repo.Add(usuario);
            }
