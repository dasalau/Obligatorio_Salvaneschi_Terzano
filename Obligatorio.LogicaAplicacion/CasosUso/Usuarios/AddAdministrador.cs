...
{
    public class AddAdministrador : ICUAddAdministrador<UsuarioDtoAlta>
    {
        private IRepositorioUsuario _repo;
        public AddAdministrador(IRepositorioUsuario repo)
        {
            _repo = repo;
        }
        ...
        public void Execute(UsuarioDtoAlta usuarioDto)
        {
            try
            {
                ...
                Administrador usuario = UsuarioMapper.FromDtoAdmininistrador(usuarioDtoMail);
                _repo.Add(usuario);
            }
